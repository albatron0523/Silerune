...
const TRIVIA_DATABASE = [
  "伊維爾因為常穿著學生制服遊蕩和嬌小的身軀，常被誤認成一年級新生。",
...
const OceanEyesShowcase: React.FC<{ isBackgroundPlaying: boolean, setIsBackgroundPlaying: (val: boolean) => void }> = ({ isBackgroundPlaying, setIsBackgroundPlaying }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full">
        ...
        {activeTab === 'art' && (
          <div className="sub-page active">
            <OceanEyesShowcase isBackgroundPlaying={isPlaying} setIsBackgroundPlaying={setIsPlaying} />
